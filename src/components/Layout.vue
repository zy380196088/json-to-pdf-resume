...
<template>
  <div>
    <p
      ...
      id="export-pdf"
      v-on:click="exportPDF('pdfResume')"
    >
      导出PDF
    </p>
    <div class="page" id="pdfResume" ref="pdfResume">
      ...
      <section class="panel skill">
        ...
        <p class="skill-item" v-for="item in skill" :key="item.index">
          {{ item }}
        </p>
      </section>
            ...
            >
              ...
              <ul>
                ...
                >
                  ...
                  <p class="project-intro" v-if="pro.intro">
                    <span class="bold">项目简介 : </span>{{ pro.intro }}
                  </p>
                  <p><span class="bold">技术栈 : </span>{{ pro.use }}</p>
                  <div class="project-details">
                    <span class="bold">工作内容 : </span>
                    <p v-for="detail in pro.details" :key="detail.index">
                      {{ detail }}
                    </p>
                  </div>
                </li>
      ...
      <section class="panel skill">
        ...
        <p class="skill-item" v-for="item in evaluation" :key="item.index">
          {{ item }}
        </p>
      </section>
      <section class="panel">
